...
class OrangePalette extends IPalette {
  @override
  Color statusBar = const Color(0xFFEEEEEE);
  @override
  Color pure = const Color(0xFFFFFFFF);
  @override
  Color primary = const Color(0xFFFF6633);
  @override
  Color primaryVariant = const Color(0xFFD6410F);
  @override
  Color secondary = const Color(0xFFF3906F);
  @override
  Color background = const Color(0xFFFAFAFA);
  @override
  Color firstText = const Color(0xFF333333);
  @override
  Color secondText = const Color(0xFF666666);
  @override
  Color thirdText = const Color(0xFF999999);
  @override
  Color firstIcon = const Color(0xFF333333);
  @override
